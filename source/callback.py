...
[InlineKeyboardButton("♪ صاحب السورس 🧑‍✈️", url=f"https://t.me/A_q_lp")],
[InlineKeyboardButton("♪ طريقة التشغيل 🧠", callback_data="bcmds"),InlineKeyboardButton("♪ طريقة التفعيل 🦸", callback_data="bhowtouse")],
[InlineKeyboardButton("♪ جروب البوت 🤖", url=f"{gr}"),InlineKeyboardButton("♪ قناه التحديثات 🐉", url=f"{ch}")],
...
[InlineKeyboardButton("♪ Bot Group 🤖", url=f"{gr}"),InlineKeyboardButton("♪ Channel Updates 🐉", url=f"{ch}")],
[InlineKeyboardButton(f"{devname}", user_id=f"{dev}")],
